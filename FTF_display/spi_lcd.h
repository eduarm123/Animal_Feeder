 ...
 */
#define LCD_DIR       vertical  // vertical、horizontal。竖屏 / 横屏
#define LCD_INVERT    invert_en  // invert_dis、invert_en。正着放 / 倒立
#define LCD_MIRROR    mirror_en  // mirror_dis、mirror_en。不开启左右镜像显示 / 开启镜像显示（可用于镜面反射及棱镜的镜像显示，可使画面左右翻转。参照分光棱镜）
...
#define PIN_NUM_DC   4 //23    // D/C线，0-命令，1-数据
//#define PIN_NUM_RST  17//36//22    // RST复位引脚。-1为空置不使用。但LCD的RST引脚应上拉接高电平。
//#define PIN_NUM_BCKL 2//21    // 背光BLK引脚。0-关闭，1-打开
